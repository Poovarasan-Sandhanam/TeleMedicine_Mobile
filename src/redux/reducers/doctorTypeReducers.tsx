import {
  ...
  const initialState = {
    profile: null,
    doctorTypes: [], // Ensure doctorTypes is initialized as an empty array
    loading: false,
    error: null,
  };
  ...
  const profileReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case FETCH_DOCTOR_TYPES_SUCCESS:
        return { ...state, doctorTypes: action.payload || [], loading: false }; // Ensure payload defaults to empty array
